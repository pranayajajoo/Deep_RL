...
if __name__ == '__main__':
    ...
    x_steps, interpolated = interpolate_returns(all_returns, all_steps)

    plot_interpolated(interpolated, x_steps, "po_ant_returns_vs_steps.png")

    # if args.track_q:
    #     x_steps, interpolated_q = interpolate_returns(q_val_dict[1]['PPO'], step_dict[1]['PPO'])
    #     plot_interpolated(interpolated_q, x_steps, "ppo_ant_q_values.png", ylabel="Q-value Estimate")
